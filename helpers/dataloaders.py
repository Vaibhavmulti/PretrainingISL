...
MAX_FRAMES = 300
POSE_DIR = '/content/drive/MyDrive/ISLRecognition/97CISLR/pose_data'
POSE_DIR_ISIGN = '/content/drive/MyDrive/ISLRecognition/97CISLR/pose_data_isign'
...
class FeatureVectorDatasetCISLR(Dataset):
    def __init__(self, video_uids, tokenizer_target,randomize_word_order, 
                 labels=None, max_frames=MAX_FRAMES, video_dir=POSE_DIR, 
                 step_frames=None, add_noise = False):
        self.video_uids = video_uids
        self.labels = labels
        self.max_frames = max_frames
